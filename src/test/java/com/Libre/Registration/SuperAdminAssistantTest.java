...
public class SuperAdminAssistantTest {
	...
	public void setUp() throws MalformedURLException {
		...
		capabilities.setCapability("deviceName", "HUX6R16903000166");
...
/*	@Test(priority = 1)
	public void loginAsSAATest() throws InterruptedException {
	...
	public void verifyMenuSectionsTest() throws InterruptedException {
		...
		menu.verifySuperAdminAssistantMenuSections();	
		isSuccess1 = true;
		driver.closeApp();
	}
	@Test(priority = 3)
